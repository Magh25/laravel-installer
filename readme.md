...
```
composer require Magh25/laravel-installer:1.9.0
```
OR add this line to `composer.json`

```
"require": {
    "Magh25/laravel-installer": "1.9.0"
}
```
2)  If you are running **Laravel 11 or above** :
```
composer require Magh25/laravel-installer:11.0.0
```
OR add this line to `composer.json`
```
"require": {
    "Magh25/laravel-installer": "11.0.0"
}
```
...
```
'providers' => [
    Magh25\LaravelInstaller\Providers\LaravelInstallerServiceProvider::class,
];
```
...
```bash
php artisan vendor:publish --provider="Magh25\LaravelInstaller\Providers\LaravelInstallerServiceProvider"
```
